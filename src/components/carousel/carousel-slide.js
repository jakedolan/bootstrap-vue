    ...
    render() {
        ...
        if (!$img && (this.imgSrc || this.imgBlank)) {
            ...
            if (!this.bvCarousel.noTouch && HAS_TOUCH_SUPPORT) {
                on.onDragstart = event => stopEvent(event, { propagation: false })
            }
        ...
        const $contentChildren = [
            ...
            h(this.captionTag, { ...htmlOrText(this.captionHtml, this.caption) }) :
            false,
            // Text
            this.text || this.textHtml ?
            h(this.textTag, { ...htmlOrText(this.textHtml, this.text) }) :
            false,
            // Children
