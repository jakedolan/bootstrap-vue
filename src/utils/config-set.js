...
export const setConfig = (app, config = {}) => {
    ...
    app.config.globalProperties[PROP_NAME] = app.config.globalProperties[PROP_NAME] || new BvConfig()
        // Apply the config values
    app.config.globalProperties[PROP_NAME].setConfig(config)
}

// Method for resetting the user config
// Exported for testing purposes only
export const resetConfig = (app) => {
    if (app.config.globalProperties[PROP_NAME] && app.config.globalProperties[PROP_NAME].resetConfig) {
      app.config.globalProperties[PROP_NAME].resetConfig()
    }
}